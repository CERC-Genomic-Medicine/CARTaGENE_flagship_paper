...
for label_i in Arrays.columns:
    for label_j in Arrays.columns:
        ...
        ax.scatter(Arrays1[column_j], Arrays1[column_i], alpha=0.5,s=20, facecolor='none', edgecolors = 'gray')
        ax.scatter(Arrays2[column_j], Arrays2[column_i], alpha=1,s=60, facecolor='none', edgecolors = 'red')
